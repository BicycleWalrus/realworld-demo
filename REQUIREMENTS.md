...
### REQ-052 — Navbar theme toggle available on every page, for all auth states
...
### REQ-053 — Chosen theme persists across reloads and visits
...
### REQ-054 — First-visit theme defaults to OS preference, else light
...
(REQ-053), it takes precedence over the OS preference on later visits.

### REQ-055 — Theme switch applies instantly with unchanged light rendering
